      ...
      <div class="popup-wrapper">
        <div class="popup-container">
          ...
          <div class="popup_wrap width_m">
            <div class="popup_title">리뷰 쓰기</div>
            <div class="popup_content_wrap">
              ...
              <div class="order_product_wrap">
                ...
                <div class="order_product_wrap__info_wrap">
                  <div class="order_product_wrap__info_wrap__brand">{{ data.store_name_kor }}</div>
                  <div class="order_product_wrap__info_wrap__title">{{ data.product_name }}</div>
                  <div class="order_product_wrap__info_wrap__txt">{{ data.ordered_at | date }} 옵션 : [{{ data.product_option_names }}] {{ data.amount | comma }}개 ㅣ {{ data.product_price | comma }}원</div>
                </div>
              </div>

              <ul class="list_wrap border_top_b7">
                <li>
                  <div class="title w_100">상품 별점선택</div>
                  <Star class="m_l_0" :size_l="true" @setStar="getStar" />
                  <div class="select_review font_12" :class="{ on: this.selectMessageOn }">상품에 만족하셨나요? 별점을 선택해주세요.</div>
                </li>
                <!--
                <li class="border_top_b7">
                  <div class="title w_100">내 키/몸무게</div>
                  <div>
                    <div class="text_input_wrap m_r_20">
                      <label for="test1">키</label>
                      <input type="text" placeholder="cm" id="test1">
                    </div>
                    <div class="text_input_wrap">
                      <label for="test2">몸무게</label>
                      <input type="text" placeholder="kg" id="test2">
                    </div>
                  </div>
                </li>
                -->
                <li class="border_top_b7">
                  <div class="title w_100">리뷰내용 작성</div>
                  <textarea rows="6" class="w_100 border_b7 p_10" placeholder="상품을 사용해 보셨다면 후기를 작성해주세요." v-model="params.content"></textarea>
                </li>
                <li>
                  <div class="title w_100">이미지 등록</div>
                  <div class="body w_100">
                    <ul class="review_show_wrap__photo_list input_file_list_wrap">
<!--                      리뷰 이미지는 최대 5장 리뷰5장이 되면 .add_thumbnail_wrap 삭제 -->
            ...
            <div class="register_terms">
              1. 포인트는 최초 작성한 리뷰를 기준으로 지급됩니다.<br>
              2. 사진 첨부시 <span class="color_main_01">캡쳐, 도용, 유사상품 촬영, 동일상품 여부 식별이 불가한 경우</span>
              에는 등록이 거절되며 사유는 별도 안내되지 않습니다.<br>
              3. 상품과 무관한 내용이나 사진, 동일 문자 반복 등의 부적합한 리뷰는 사전 경고 없이 삭제 및 포인트 회수될 수 있습니다.
            </div>
          </div>
