      ...
      <div class="popup-wrapper">
        <div class="popup-container">
          ...
          <div class="popup_wrap">
            <div class="popup_title text-center">이미지 검색</div>
            <div class="popup_text_wrap">
              ...
              <ul class="list_wrap w_100">
                ...
                <li v-if="isSelectedCompleted" class="m_b_0">
                  <div class="upload_image_wrap">
                    <div class="image_wrap" v-if="uploadFileUrl">
                      <img :src="uploadFileUrl"/>
                    </div>
                    <span v-else class="txt">이미지를 업로드해주세요.</span>
                  </div>
                </li>
                <li v-if="isSelectedCompleted">
                  <div class="upload_image_btn w_100">
                    <input type="file" id="search_image_file" @change="uploadImage" accept="image/*"/>
                    <label for="search_image_file">이미지 업로드</label>
                  </div>
                </li>
              </ul>
