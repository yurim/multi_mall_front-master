              ...
              <div>
                    ...
                    <tr>
                      <th>
                        <div class="checkbox_wrap">
                          <input type="checkbox" id="all_check" v-model="allSelect">
                ...
                <ul class="list_wrap">
                  <li>
                    ...
                    <div class="body">
                      <select v-model="params.delivery_method" v-on:change="setDeliveryMethod">
                        <option value="">선택</option>
                        <option v-for="code in deliveryMethodCodeList" :value="code.key">{{code.value}}</option>
                      </select>
                    </div>
                  </li>
                  <template v-if="params.delivery_method === 'PARCEL'">
                    <li>
                      <div class="title">택배사</div>
                      <div class="body">
                        <select v-model="params.delivery_company">
                          <option value="">선택</option>
                          <option v-for="code in deliveryCompanyCodeList" :value="code.key">{{code.value}}</option>
                        </select>
                      </div>
                    </li>
                    <li>
                      <div class="title">택배사</div>
                      <div class="body">
                        <input type="text" placeholder='송장번호를 입력해주세요.' class="w_100" v-model="params.invoice_num">
                      </div>
                    </li>
                  </template>
                </ul>
