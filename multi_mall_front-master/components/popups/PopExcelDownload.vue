        ...
        <div class="popup-container">
          ...
          <div class="popup_wrap">
            ...
            <div class="popup_text_wrap">
              ...
              <div>
                <select v-model="params.pageSize" v-on:change="changePageSize">
            ...
            <div class="popup_text_wrap">
              ...
              <div>
                <select v-model="params.page" v-on:change="setParams">
                  <option v-for="inPage in pageList" :value="inPage">{{boundaryPage(inPage)}}</option>
                </select>
              </div>
            </div>
