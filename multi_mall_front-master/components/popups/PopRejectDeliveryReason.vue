              ...
              <ul class="list_wrap w_100">
                ...
                <div v-if="redelivery">
                  <li>
                    ...
                    <div class="body">
                      <select v-model="params.delivery_method">
                        <option v-for="code in codesArray('delivery_method')" :value="code.key">{{code.value}}</option>
                      </select>
                    </div>
                  </li>
                  <li>
                    ...
                    <div class="body">
                      <select v-model="params.delivery_company">
                        <option v-for="code in codesArray('delivery_company')" :value="code.key">{{code.value}}</option>
                      </select>
                    </div>
                  </li>
                  <li>
