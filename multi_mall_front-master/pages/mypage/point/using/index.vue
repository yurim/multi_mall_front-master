      ...
      <div>
        ...
        <div class="list_title_wrap m_b_10">
          <ul class="tab_menu_wrap pull-left">
            <li><nuxt-link to="/mypage/point/saving">적립 내역</nuxt-link></li>
            <li><a class="on">차감 내역</a></li>
          </ul>
        </div>
        <div>
          <table>
          ...
          <div class="pagenation_wrap">
            <Pagenation :total-count="totalCount" :page-size="pageSize" :default-page="defaultPage" :page-key-name="'page'" :page-size-key-name="'page_size'" :onPage="onPage" />
          </div>
        </div>
      </div>
    </v-container>
