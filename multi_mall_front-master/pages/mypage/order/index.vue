    ...
    <v-container>
      ...
      <div>
        ...
        <div class="mypage_wrap">
          <div class="main_color_title">주문 배송 조회</div>
...
<!--            </div>-->
          ...
          <div class="col_wrap m_t_20">
            <div class="col_three order_wrap w_100">
              <!-- ul 1개 = 스토어 1개-->
                        ...
                        <tr v-for="(product, prdIdx) in group.order_products" :key="`groupProducts_${product.id}`">
                          ...
                          <td class="text-center">
                            ...
                            <div class="square_but_wrap coupon_wrap m_t_10">
                              ...
                              <a class="line_but" v-if="product.payment_method !== 'NAVER' &&(['CNCL','EXCHNG', 'RTRN'].indexOf(product.order_status) >= 0 || product.claim_rejected)"
