    ...
    <v-container>
      ...
      <div class="m_t_40">
        <div class="mypage_info_wrap">
          <div class="main_color_title m_t_40">주문 배송 조회</div>

          <div class="order_wrap">
            <div class="d_ib_100 pull-left">
              <!-- todo: 2차 개발 -->
<!--              <ul class="order_condition_wrap m_b_40">-->
<!--                <li>-->
<!--                  <a>-->
<!--                    <div class="text_wrap">전체보기</div>-->
<!--                  </a>-->
<!--                </li>-->
<!--                <li v-for="(type, i) in orderStatusList" :key="`${type.value}_${i}`">-->
<!--                  <a>-->
<!--                    <div class="text_wrap">{{ type.text }}</div>-->
<!--                    <div class="num_wrap">{{ type.count }}</div>-->
<!--                  </a>-->
<!--                </li>-->
<!--              </ul>-->
<!--              <div class="select_date_wrap">-->
<!--                <search-date-picker ref="searchDatePicker" dateFormat="YYYY-MM-DDzz" :dateTypes="orderStatusList"></search-date-picker>-->
                ...
                <li v-if="order.stores.length > 0">
                  <table>
                    ...
                    <thead>
                      <tr>
                        <td colspan="6">
                          <b>일시:</b> {{ $moment(order.ordered_at).format('YYYY년MM월DD일 HH시mm분') }}
                          <b>주문번호:</b> {{ order.order_num }}
                          <div class="square_but_wrap pull-right">
                            <nuxt-link :to="`/non_member/order/${order.id}`">주문상세보기</nuxt-link>
                          </div>
                        </td>
                      </tr>
                    </thead>
                            ...
                            <td class="text-center">
                              <div class="square_but_wrap coupon_wrap font_12">
                                ...
                                <nuxt-link
                                  ...
                                  :to="`/non_member/order/cancel/${product.id}`"
                                >
                                  주문취소
                                </nuxt-link>
                                <nuxt-link
                                  ...
                                  v-if="product.order_status === 'DLVRNG'
                                        || product.order_status === 'DLVRY_CMPLT'
                                        || (product.order_status === 'EXCHNG' && product.order_sub_status === 'EXCHNG_RDLVRY')"
                                  :to="`/non_member/order/exchange/${product.id}`"
                                >
                                  교환신청
                                </nuxt-link>
                                <nuxt-link
                                  ...
                                  v-if="product.order_status === 'DLVRNG'
                                        || product.order_status === 'DLVRY_CMPLT'
                                        || (product.order_status === 'EXCHNG' && product.order_sub_status === 'EXCHNG_RDLVRY')"
                                  :to="`/non_member/order/return/${product.id}`"
                                >
                                  반품신청
                                </nuxt-link>
                                <a
...
<script src="@/assets/javascripts/non_member/order/index.js"></script>
