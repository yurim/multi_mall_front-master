      ...
      <div>
        ...
        <div class="col_wrap m_t_20">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="textarea_wrap">
                        <textarea cols="30" rows="10" v-model="order_product_return.reason"></textarea>
                      </div>
                    </td>
                  </tr>
                  </tbody>
                      ...
                      <td>
                        <div class="radio_wrap">
                          <template v-for="type in collectDeliveryTypeCodes">
                            <input type="radio" name="collectDeliveryType" :key="`collectDeliveryType_${type.key}`" :id="`${type.key}_${type.value.code}`" :value="type.value.code" v-model="order_product_return.collect_delivery_type">
          ...
          <div class="col_one cancel_warp">
                        ...
                        <td>
                          <div class="radio_wrap">
                            <template v-for="type in collectFeeTypeCodes">
                              <input type="radio" name="collectFeeType" :id="`${type.key}_${type.value.code}`" :value="type.value.code" v-model="order_product_return.collect_fee_type" :key="`collectFeeType_${type.key}`">
            ...
            <ul v-if="order_product_return.collect_fee_type === 'VBANK'">
              <li class="title">반품 배송비 정보 <span class="font_10">(무통장입금)</span></li>
                ...
                <div class="cart_table_wrap">
                  <table>
                    ...
                    <tr class="border_b_light">
                      <th class="font_14">입금 금액<br>(반품 배송비)</th>
                      <td>{{ orderProduct.return_fee | comma }}원</td>
                    </tr>
                    <tr>
                      <th>상품 취소 금액</th>
            ...
            <ul v-if="order_product_return.collect_fee_type === 'ATTACH'">
              <li class="title">반품 배송비 정보 <span class="font_10">(동봉)</span></li>
              <li><span class="font_10">아래 표시되는 금액은 참고용이며, 책임여부와 판매자 사정으로 인해 금액이 변동될 수 있습니다.</span></li>
              <li>
                <div class="cart_table_wrap">
                  <table>
            ...
            <ul v-if="order_product_return.collect_fee_type === 'SELLER_DECIDES'">
              <li class="title">반품 배송비 정보 <span class="font_10">(판매자와 상담 후 결정)</span></li>
              <li><span class="font_10">아래 표시되는 금액은 참고용이며, 책임여부와 판매자 사정으로 인해 금액이 변동될 수 있습니다.</span></li>
              <li>
                <div class="cart_table_wrap">
                  <table>
                    ...
                    <tr class="border_b_light">
                      <th>예상 반품 배송비</th>
                      <td v-if="selectedReasonObject.responsible_for !== 'SELLER'">{{ orderProduct.return_fee | comma }}원</td>
                      <td v-else>0 원</td>
                    </tr>
                    <tr>
                      <th>상품 취소 금액</th>
        ...
        <div class="but_wrap text-center">
          <a class="line_but" v-on:click="cancelReturn">취소</a>
          <a v-on:click="requestReturn">반품 요청</a>
        </div>
      </div>
    </v-container>
    <Footer></Footer>
...
<script src="@/assets/javascripts/non_member/order/return/_id/index.js"></script>
