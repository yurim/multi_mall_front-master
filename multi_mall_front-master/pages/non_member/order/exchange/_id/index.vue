    ...
    <v-container>
      ...
      <div>
        ...
        <div class="but_wrap text-center">
          <a v-on:click="cancelExchange">취소</a>
          <a class="line_but" v-on:click="requestExchange">교환 요청</a>
        </div>
      </div>
    </v-container>
    <Footer></Footer>
...
<script src="@/assets/javascripts/non_member/order/exchange/_id/index.js"></script>
