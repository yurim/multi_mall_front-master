  ...
  <div class="userWrap">
    ...
    <v-container v-if="order">
      ...
      <div class="col_wrap m_t_20">
        <div class="d_ib_100 order_complete_wrap">
          <div class="m_b_10 order_complete_wrap__title_wrap">
            <b><span class="color_main_01">주문이 완료</span>되었습니다. 감사합니다!</b>
          </div>
            ...
            <li>
              <table>
                ...
                <tr v-if="order.order_payment.payment_method ==='VBANK'">
                  <th>입금계좌</th>
                  <td>{{ order.order_payment.virtual_account_bank }} {{ order.order_payment.virtual_account_num }}
                ...
                <tr v-else>
                  <th>결제수단</th>
                  <td>{{ order.order_payment.payment_method_str }} {{ order.paid_at | date }}</td>
                </tr>
                </tbody>
              </table>
            </li>
        ...
        <div class="col_one">
          <ul>
            ...
            <li>
              <div class="cart_table_wrap border_t_dark">
...
<!--                    <td>{{ order.total_coupon_price | comma }}원</td>-->
<!--                  </tr>-->
                  </tbody>
                  <tfoot>
                    <th>총 결제 금액</th>
                    <td><span class="color_main_01"><b>{{ order.paid_price | comma }}원({{ order.total_amount }}개)</b></span></td>
                  </tfoot>
                </table>
              </div>
            </li>
