                ...
                <li>
                  ...
                  <div class="body">
                    <div class="checkbox_wrap">
                      ...
                      <label for="one">전부 구매완료된 주문건</label>
                      <input type="checkbox" id="two" checked>
                      <label for="two">미완료가 포함된 주문건</label>
                    </div>
                  </div>
                </li>
                <li>
                  ...
                  <div class="body">
                    <div class="checkbox_wrap">
                      ...
                      <label for="three">필요함</label>
                      <input type="checkbox" id="four" checked>
                      <label for="four">필요안함</label>
                    </div>
                  </div>
                </li>
                <li>
                  ...
                  <div class="body">
                    <div class="checkbox_wrap">
                      ...
                      <label for="five">필요</label>
                      <input type="checkbox" id="six" checked>
                      <label for="six">불필요</label>
                    </div>
                  </div>
                </li>
                <li>
                  ...
                  <div class="body">
                    <div class="select_input_wrap">
                      <div class="checkbox_wrap">
                        ...
                        <label for="seven">신청완료</label>
                        <input type="checkbox" id="eight" checked>
                        <label for="eight">미신청</label>
                      </div>
                      <select>
              ...
              <li class="page_title">
                <div class="pull-left">
                  <div class="select_div_wrap">
                    <div>조회결과 <span>({{ orderTotalCount }}건)</span></div>
                    <select>
                      <option>담당자 일괄지정</option>
                    </select>
                  </div>
                </div>
                <div class="square_but_wrap pull-right">
                  <div class="pull-right">
                    <a class="gray_but" href="javascript:;">구매처리 엑셀업로드</a>
                    <a class="gray_but" href="javascript:;">발송처리 엑셀업로드</a>
                ...
                <div class="table_scroll_m">
                  <table>
                    ...
                    <tr>
                      <td rowspan="2">
                        <div class="only_checkbox_wrap">
                          <input type="checkbox" id="product_check_1">
                          <label for="product_check_1"></label>
                        </div>
                      </td>
                      ...
                      <td rowspan="2">
                        <input type="text" placeholder="국내 운송장번호 입력">
                      </td>
                      <td rowspan="2">
                      ...
                      <td>
                        <div class="only_checkbox_wrap">
                          <input type="checkbox" id="product_check_2" checked>
                          <label for="product_check_2"></label>
                        </div>
                      </td>
                      <td>
                        <input type="text" placeholder="해외 주문번호 입력">
                      </td>
                      <td>
                        <input type="text" placeholder="해외 운송장번호 입력">
                      </td>
                      <td>
                        <div class="square_but_wrap">
                          <a href="javascript:;">저장</a>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="only_checkbox_wrap">
                          <input type="checkbox" id="product_check_3" checked disabled>
                          <label for="product_check_3"></label>
                        </div>
                      </td>
                      <td>
                        <input type="text" placeholder="해외 주문번호 입력">
                    ...
                    <tr>
                      <td rowspan="2">
                        <div class="only_checkbox_wrap">
                          <input type="checkbox" id="product_check_4">
                          <label for="product_check_4"></label>
                        </div>
                      </td>
                      <td rowspan="2">2020.01.01<br/>10:10:10</td>
                      <td rowspan="2">
                      ...
                      <td>
                        <div class="only_checkbox_wrap">
                          <input type="checkbox" id="product_check_5" checked disabled>
                          <label for="product_check_5"></label>
                        </div>
                      </td>
                      <td>
                        <input type="text" placeholder="해외 주문번호 입력">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="only_checkbox_wrap">
                          <input type="checkbox" id="product_check_6" checked disabled>
                          <label for="product_check_6"></label>
                        </div>
                      </td>
                      <td>
                        <input type="text" placeholder="해외 주문번호 입력">
                    ...
                    <tr>
                      <td rowspan="2">
                        <div class="only_checkbox_wrap">
                          <input type="checkbox" id="product_check_7">
                          <label for="product_check_7"></label>
                        </div>
                      </td>
                      <td rowspan="2">2020.01.01<br/>10:10:10</td>
                      <td rowspan="2">
                      ...
                      <td>
                        <div class="only_checkbox_wrap">
                          <input type="checkbox" id="product_check_8" checked disabled>
                          <label for="product_check_8"></label>
                        </div>
                      </td>
                      <td>
                        <input type="text" placeholder="해외 주문번호 입력">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="only_checkbox_wrap">
                          <input type="checkbox" id="product_check_9" checked disabled>
                          <label for="product_check_9"></label>
                        </div>
                      </td>
                      <td>
                        <input type="text" placeholder="해외 주문번호 입력">
                    ...
                    <tr>
                      <td rowspan="2">
                        <div class="only_checkbox_wrap">
                          <input type="checkbox" id="product_check_10">
                          <label for="product_check_10"></label>
                        </div>
                      </td>
                      <td rowspan="2">2020.01.01<br/>10:10:10</td>
                      <td rowspan="2">
                      ...
                      <td>
                        <div class="only_checkbox_wrap">
                          <input type="checkbox" id="product_check_11" checked>
                          <label for="product_check_11"></label>
                        </div>
                      </td>
                      <!--  "담당업체가 미신청일때만"  인풋 비활성화  -->
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="only_checkbox_wrap">
                          <input type="checkbox" id="product_check_12" checked disabled>
                          <label for="product_check_12"></label>
                        </div>
                      </td>
                      <td>
                        <input type="text" placeholder="해외 주문번호 입력">
                    ...
                    <tr>
                      <td rowspan="2">
                        <div class="only_checkbox_wrap">
                          <input type="checkbox" id="product_check_13">
                          <label for="product_check_13"></label>
                        </div>
                      </td>
                      <td rowspan="2">2020.01.01<br/>10:10:10</td>
                      <td rowspan="2">
                      ...
                      <td>
                        <div class="only_checkbox_wrap">
                          <input type="checkbox" id="product_check_14">
                          <label for="product_check_14"></label>
                        </div>
                      </td>
                      <td>
                        <input type="text" placeholder="해외 주문번호 입력">
                    ...
                    <tr class="bg_yellow">
                      ...
                      <td>
                        <div class="only_checkbox_wrap">
                          <input type="checkbox" id="product_check_15" checked>
                          <label for="product_check_15"></label>
                        </div>
                      </td>
                      <td>
                        <input type="text" placeholder="해외 주문번호 입력">
                    ...
                    <tr>
                      <td rowspan="2">
                        <div class="only_checkbox_wrap">
                          <input type="checkbox" id="product_check_16">
                          <label for="product_check_16"></label>
                        </div>
                      </td>
                      <td rowspan="2">2020.01.01<br/>10:10:10</td>
                      <td rowspan="2">
                      ...
                      <td rowspan="2">
                        ...
                        <!-- 신청하기 클릭시 'PopAmazic9Requeat' 팝업이 나와야함 -->
                        <div class="square_but_wrap">
                          <a href="javascript:;">신청하기</a>
                        </div>
                      </td>
                      ...
                      <td>
                        <!-- '발주확인' 클릭시 발주확인 버튼은 없어지고 상품준비중에서 배송준비중으로 상태 변경되야함 -->
                        <span>상품준비중</span>
                        <div class="square_but_wrap">
                          <a href="javascript:;">발주확인</a>
                        </div>
                      </td>
                      <td>핀둬둬</td>
                      <td>
                      ...
                      <td>
                        <div class="only_checkbox_wrap">
                          <input type="checkbox" id="product_check_17" checked disabled>
                          <label for="product_check_17"></label>
                        </div>
                      </td>
                      <td>
                        <input type="text" placeholder="해외 주문번호 입력">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="only_checkbox_wrap">
                          <input type="checkbox" id="product_check_18" checked>
                          <label for="product_check_18"></label>
                        </div>
                      </td>
                      <td>
                        <input type="text" placeholder="해외 주문번호 입력">
                ...
                <li>
                  ...
                  <div class="body">
                    <div class="checkbox_wrap">
                      ...
                      <label for="item_1">전부 구매완료된 주문건</label>
                      <input type="checkbox" id="item_2" checked>
                      <label for="item_2">미완료가 포함된 주문건</label>
                    </div>
                  </div>
                </li>
                <li>
                ...
                <li>
                  ...
                  <div class="body">
                    <div class="checkbox_wrap">
                      ...
                      <label for="item_5">필요</label>
                      <input type="checkbox" id="item_6" checked>
                      <label for="item_6">불필요</label>
                    </div>
                  </div>
                </li>
                <li>
                ...
                <div class="table_scroll_m">
                  <table>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="only_checkbox_wrap">
                          <input type="checkbox" id="product_check_2_2" checked>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="only_checkbox_wrap">
                          <input type="checkbox" id="product_check_11_11" checked>
                          <label for="product_check_11_11"></label>
                        </div>
                      </td>
                      <!--  "담당업체가 미지정일때만"  인풋 비활성화  -->
                      <td>
                        <input type="text" placeholder="해외 주문번호 입력" disabled>
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="only_checkbox_wrap">
                          <input type="checkbox" id="product_check_14_14">
                    ...
                    <tr class="bg_yellow">
                      ...
                      <td>
                        <div class="only_checkbox_wrap">
                          <input type="checkbox" id="product_check_15_15" checked>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="only_checkbox_wrap">
                          <input type="checkbox" id="product_check_18_18" checked>
...
<script src="@/assets/javascripts/store_admin/amazic9/index.js"></script>
