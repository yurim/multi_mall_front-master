        ...
        <div class="content_box_wrap">
          <div class="col_wrap">
            ...
            <div class="col_three">
              <ul class="table_wrap">
                <li class="page_title">
                  <div>묶음배송그룹 템플릿 수정</div>
                </li>
                <li>
                  <div class="title">템플릿명</div>
                  <div class="body"><input type="text" placeholder="내용을 입력하세요" v-model="deliveryGroup.name"></div>
                </li>
                <li>
                  <div class="title">배송방법</div>
                  <div class="body">
                    <div class="checkbox_wrap">
                      <input type="checkbox" id="isDefault" v-model="deliveryGroup.is_default">
                ...
                <li>
                  ...
                  <div class="body">
                    <div class="radio_wrap">
                      <input type="radio" name="isSmaller" id="isSmallerTrue" :value="true" v-model="deliveryGroup.is_smaller">
                ...
                <li>
                  ...
                  <div class="body">
                    ...
                    <div class="radio_wrap m_b_10" v-if="isMountainAreaSetting === true">
                      <span>배송권역</span>
                      <input type="radio" name="mountainArea" id="TOTAL" v-model="mountainArea" :value="2" v-on:click="mountainAreaType">
                      <label for="TOTAL">2권역</label>
                      <input type="radio" name="mountainArea" id="JEJU-CNTRY_MNTN" v-model="mountainArea" :value="3" v-on:click="mountainAreaType">
              ...
              <div class="but_wrap text-center">
                ...
                <a v-on:click="patchDeliveryGroup">저장</a>
              </div>
            </div>
...
<script src="@/assets/javascripts/store_admin/template/delivery_group/edit/_id/index.js"></script>
