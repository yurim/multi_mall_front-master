...
<!--                </li>-->
                ...
                <li>
                  ...
                  <div class="body">
                    <div>
                      <span>{{ delivery_info.departure_address }} {{ delivery_info.departure_detail_address }} {{ delivery_info.departure_zipcode }}</span>
                      <span>
                ...
                <li>
                  ...
                  <div class="body">
                    <span>{{ delivery_info.arrival_address }} {{ delivery_info.arrival_detail_address }} {{ delivery_info.arrival_zipcode }}</span>
                    <span>
              ...
              <div class="but_wrap text-center">
                <nuxt-link class="line_but" to="/store_admin/template/delivery">취소</nuxt-link>
                <a v-on:click.prevent="createDelivery">저장</a>
              </div>
...
<script src="@/assets/javascripts/store_admin/template/delivery/new/index.js"></script>
