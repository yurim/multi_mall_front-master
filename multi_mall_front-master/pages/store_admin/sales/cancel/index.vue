                ...
                <li>
                  ...
                  <div class="body">
                    <div class="small_but_wrap">
                      <a href="javascript:;" class="line_but" @click="btnCancelReject">취소 거부처리</a>
<!--                      <a href="javascript:;" class="line_but" @click="btnCancelAccept">취소(환불)완료처리</a>-->
                    </div>
                  </div>
                </li>
              </ul>
...
<script src="@/assets/javascripts/store_admin/sales/cancel/index.js"></script>
