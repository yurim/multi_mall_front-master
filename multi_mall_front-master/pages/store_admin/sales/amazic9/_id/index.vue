              ...
              <li>
                <table>
                  ...
                  <tr>
                    <th>주문번호</th>
                    <td>
                      <nuxt-link :to="`/store_admin/sales/${delivery_request.infos[0].order_product.order_num}`" class="color_b">
                        {{ order.order_num }}
                      </nuxt-link>
                    </td>
                    <th>주문자 아이디</th>
              ...
              <li>
                ...
                <table>
                  ...
                  <template v-for="(info, infoIndex) in delivery_request.infos">
                    ...
                    <tr class="tbody_group_list">
                      <th>해외 주문번호</th>
                      <th colspan="2">해외 운송장번호</th>
                      <th>저장</th>
                    </tr>
                    <tr class="tbody_group_list">
                      <td>
                          <input v-model="info.delivery_product.order_product_delivery_request.abroad_order_num" type="text">
                      </td>
                      <td colspan="2">
                          <input v-model="info.delivery_product.order_product_delivery_request.abroad_tracking_num" type="text">
                      </td>
                      <td>
                        <div class="but_wrap l_h_34 text_center">
                          <a @click="updateTrackingNum(info.delivery_product.order_product_delivery_request)">저장</a>
                        </div>
                      </td>
                      <td colspan="2">
                        <div class="body">
                    ...
                    <tr class="tbody_group_list">
                      <th>택배사</th>
                      <th colspan="2">국내 운송장번호</th>
                      <th>저장</th>
                    </tr>
                    <tr>
                      <td>
                        <select v-model="delivery_request.delivery_company">
                      ...
                      <td colspan="2">
                          <input v-model="delivery_request.invoice_num" type="text">
                      </td>
                      <td>
                        <div class="but_wrap l_h_34 text_center">
                          <a @click="updateInvoiceNum(delivery_request, info)">저장</a>
                        </div>
                      </td>
                      <td colspan="2">
                        <div class="body">
...
<script src="@/assets/javascripts/store_admin/sales/amazic9/_id/index.js"></script>
