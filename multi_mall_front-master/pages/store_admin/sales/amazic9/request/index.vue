              ...
              <li>
                ...
                <table v-for="(deliveryProduct, dpIndex) in deliveryProducts" :key="deliveryProduct.info.order_num">
                  ...
                  <tr class="tbody_group_list">
                    ...
                    <td>
                      <input type="text" placeholder="제품명" v-model="deliveryProduct.eng_name">
                    </td>
                    <td>
                      <input type="text" placeholder="옵션" v-model="deliveryProduct.option">
                    </td>
                    <td>
                      <input type="text" placeholder="구매처" v-model="deliveryProduct.purchase_place">
                    </td>
                    <td>
                      <input type="number" placeholder="수량" v-model="deliveryProduct.amount" @input="calcTotalPrice">
                    </td>
                    <td class="list_half">
                    ...
                    <td colspan="9">
                      <div class="radio_wrap">
                        <input type="radio" :id="`select_option_image_${dpIndex}`" v-model="deliveryProduct.option_image.type" value="select"
                               :disabled="!deliveryProduct.info.product.additional_images || deliveryProduct.info.product.additional_images.length < 1">
                  ...
                  <tr class="tbody_group_list">
                    <td colspan="9" class="border_none">
                      <div class="color_r">* 핀둬둬, 타오바오 상품일 경우에는 해외주문번호 및 해외 트래킹넘버는 필수 입력사항이 아닙니다.</div>
                    </td>
                  </tr>
                  </tbody>
                </table>
...
<script src="assets/javascripts/store_admin/sales/amazic9/request/index.js"></script>
