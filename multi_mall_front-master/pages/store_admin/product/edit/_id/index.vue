              ...
              <ul>
                <li class="page_title">
                  ...
                  <div class="pull-right">
                    <div class="but_wrap">
                        <nuxt-link class="line_but" :to="`/store_admin/product/${product.id}`">취소</nuxt-link>
                        <a v-on:click="updateProduct">수정</a>
                    </div>
                  </div>
                </li>
                <li>
                ...
                <li>
                  ...
                  <div class="body input_but_wrap">
                    <input type="text" placeholder="내용을 입력해주세요." v-model="product.name" v-on:keyup="resetIsCheckedProductName" />
                    <span v-if="!isCheckedProductName">
                      <a class="small_but_style" v-on:click="checkProductName">중복검사</a>
                    </span>
                  </div>
                </li>
                  ...
                  <div class="body">
                    <div class="radio_wrap">
                      <template v-for="(target, i) in targets">
                        <input type="radio" name="productTarget" :id="target.key" :key="`target_${i}`" :value="target.key" v-model="product.target"/>
                ...
                <li>
                  ...
                  <div class="body">
                    <div class="radio_wrap">
                      <input type="radio" name="isAbroadProduct" id="domestic" :value="false" v-model="product.is_abroad" />
                      <label for="domestic">국내상품</label>
                ...
                <li>
                  ...
                  <div class="body">
                    <input type="text" v-model="product.detail_url" placeholder="내용을 입력하세요." v-on:keyup="validateUrl(product.detail_url)" />
                 ...
                 <li>
                  ...
                  <div class="body">
                    <input type="text" v-model="product.affiliate_url" placeholder="내용을 입력하세요." v-on:keyup="validateUrl(product.affiliate_url)"/>
                ...
                <li v-if="product.is_abroad">
                  ...
                  <div class="body">
                    <input type="number" class="w_25 m_r_10 pull-left text-right" placeholder="0" @blur="blurPrice" v-model="product.abroad_price.price" v-on:keyup="calcAbroadPrice"/>
                    <span>{{ product.abroad_price.currency_unit.name }} ({{ product.abroad_price.currency_unit.unit }})</span>
                ...
                <li v-if="!product.display_only">
                  ...
                  <div class="body">
                    <div class="radio_wrap">
                      <input type="radio" name="isDiscount" id="type_NONE" :value="'NONE'" v-model="product.discount_type" v-on:click="resetDiscount" checked />
                      <label for="type_NONE">없음</label>
                      <input type="radio" name="isDiscount" id="type_PRICE" :value="'PRICE'" v-model="product.discount_type" v-on:click="resetDiscount" />
                      <label for="type_PRICE">금액</label>
                      <input type="radio" name="isDiscount" id="type_PRCNT" :value="'PRCNT'" v-model="product.discount_type" v-on:click="resetDiscount" />
              ...
              <ul v-if="product.option_type === 'ASSCTN'">
                ...
                <li>
                  <div class="table_top_wrap square_but_wrap">
                    ...
                    <a class="gray_but" v-on:click="updateOptionValue">옵션값명 변경</a>
                    <div>
                      ...
                      <tr v-for="(composition, i) in product.option_compositions" v-bind:key="`option_composition_${i}`">
                        ...
                        <td v-if="product.use_option_image">
                          <template v-for="(option_value, k) in composition.option_values">
                            <span v-if="optionValueImageMap[`${option_value.option.id}_${option_value.id}`]" v-bind:key="`option_value_image_${k}`" class="thumbnail_wrap m_r_10">
                              <img v-bind:src="optionValueImageMap[`${option_value.option.id}_${option_value.id}`].image" v-bind:id="`option_value_image_${k}`" />
                            </span>
                          </template>
                        </td>
                        <td v-for="(option, j) in product.options" v-bind:key="`option_value_${i}_${j}`">
...
<!--                  &lt;!&ndash; 조합형 일반, 이미지 옵션 클릭시 e &ndash;&gt;-->
<!--                  <div class="but_wrap m_t_10">-->
...
<!--                  </div>-->
              ...
              <!-- 단독형 s -->
              <ul v-if="product.option_type === 'STDALN'">
                <li class="title">옵션목록</li>
                <li>
                  <div class="table_top_wrap square_but_wrap">
                    <a class="gray_but" v-on:click="setOptionImage" v-if="product.use_option_image">옵션이미지</a>
                  ...
                  <table>
                    ...
                    <tbody>
                      <tr v-for="(composition, i) in product.option_compositions" v-bind:key="i">
                        ...
                        <td v-if="product.use_option_image">
                          <template v-for="(option_value, k) in composition.option_values">
                            <span v-if="optionValueImageMap[`${option_value.option.id}_${option_value.id}`]" v-bind:key="`image_${k}`" class="thumbnail_wrap m_r_10">
                              <img v-bind:src="optionValueImageMap[`${option_value.option.id}_${option_value.id}`].image" v-bind:id="`image_${k}`" />
                            </span>
                          </template>
                        </td>
...
<!--                  </div>-->
              ...
              <!-- 조합형, 단독형 옵션이미지 노출 여부 s -->
<!--              <ul v-if="option_type_of_type === 'image'">-->
<!--                <li class="title">옵션이미지 노출 여부</li>-->
<!--                <li>-->
<!--                  <div class="radio_wrap">-->
...
<!--              </ul>-->
              ...
              <ul>
                ...
                <li>
                  ...
                  <div class="body">
                    <client-only>
                      <SummernoteEditor @setDetailContent="onEditor" :detailContent="product.content" :detailImageArr="product.detail_images"></SummernoteEditor>
                    </client-only>
                  </div>
                </li>
              </ul>
              ...
              <ul>
                ...
                <li>
                  ...
                  <div class="body">
                    <select class="d_ib_100" v-model="product.delivery_info.delivery_info_id" v-on:change="selectedDeliveryInfo">
                      <option value="">선택</option>
              ...
              <ul v-if="isUpdateDeliveryTemplate">
                  ...
                  <div class="body">
                    ...
                    <div v-if="isDeliveryGroup">
                      <select v-model="product.delivery_info.delivery_group_id" v-on:change="setSelectedDeliveryGroup">
                        <option value="">선택</option>
                        <option v-for="item in deliveryGroups" v-bind:key="item.id" v-bind:value="item.id">{{ item.name }}</option>
                      </select>
                ...
                <li v-if="!['', 'FREE', 'CHARGE'].includes(product.delivery_info.delivery_fee_type)">
                  ...
                  <div class="body" v-if="product.delivery_info.delivery_fee_type === 'AREA'">
                    <!-- 구간별 -->
<!--                    <div class="radio_wrap">-->
<!--                      <input type="radio" id="conditionValueToo" name="conditionValue" v-on:click="conditionValue(2)" />-->
<!--                      <label for="conditionValueToo">2구간</label>-->
<!--                      <input type="radio" id="conditionValueThree" name="conditionValue" v-on:click="conditionValue(3)" />-->
...
<!--                    </div>-->
                ...
                <li>
                  ...
                  <div class="body">
                    <div class="radio_wrap">
                      <input type="radio" name="setMountainArea" id="isMountainAreaTrue" v-bind:value="true"
                             v-model="isCountryMountainDelivery" v-on:change="setIsCountryMountainDelivery" :disabled="isDisabledCountryMountainDelivery" />
                      <label for="isMountainAreaTrue">설정</label>
                      <input type="radio" name="setMountainArea" id="isMountainAreaFalse" v-bind:value="false"
                             v-model="isCountryMountainDelivery" v-on:change="setIsCountryMountainDelivery" :disabled="isDisabledCountryMountainDelivery" />
                    ...
                    <div class="text_input_wrap d_ib_100 m_t_0" v-if="isCountryMountainDelivery" v-for="(item, i) in Object.values(product.country_mountain_deliveries)" v-bind:key="item.area_type">
...
<script src="@/assets/javascripts/store_admin/product/edit/_id/index.js"></script>
