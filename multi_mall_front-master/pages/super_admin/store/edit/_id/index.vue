            ...
            <form>
              <div class="col_three">
                <ul>
                  ...
                  <li>
                    <div class="title">매장명(한글)<span class="color_r">&#42;</span></div>
                    <div class="body">
                  ...
                  <li>
                    ...
                    <div class="body">
                      ...
                      <div class="checkbox_wrap">
                        <input type="checkbox" id="is_crawling" v-model="store.is_crawling" v-on:click="isCrawling">
                    ...
                    <div class="body">
                      <div class="radio_wrap">
                        <template v-for="type in storeTypes">
                          <input type="radio" :id="type.key" :value="type.key" name="storeType" v-model="store.store_type" :key="type.value" :checked="type.key === store.store_type">
                          <label :for="type.key" :key="type.key">{{ type.value }}</label>
                        </template>
                      </div>
                      <div class="checkbox_wrap" v-if="store.store_type === 'ROAD' || store.store_type === 'INTERNET' || store.store_type === 'BRAND'">
                  ...
                  <li>
                    ...
                    <div class="body">
                      <div class="address_wrap">
                        <input type="text" placeholder="우편번호" v-on:click="setAddress('store')" v-model="store.zipcode">
                        <a id="store" v-on:click="postCode">우편번호</a>
                        <input type="text" placeholder="주소" v-on:click="setAddress('store')" v-model="store.address">
                  ...
                  <li>
                    ...
                    <div class="body"><input type="number" placeholder="- 를 제외한 번호만 입력해주세요." v-model.lazy="store.cs_phone"></div>
                  </li>
                  <li>
                    ...
                    <div class="body">
                      <div class="mount_child__btn_wrap">
                        ...
                        <div class="fix"><a v-on:click="addCategoryGroup">추가</a></div>
                      </div>
                  ...
                  <li>
                    ...
                    <div class="body"><input type="text" placeholder="내용을 입력해주세요." v-model.lazy="store.kakao_plus_url"></div>
                  </li>
                  <li>
                    <div class="title">인스타그램 아이디</div>
                    <div class="body"><input type="text" placeholder="내용을 입력해주세요." v-model.lazy="store.instagram_id"></div>
                  </li>
                </ul>
                    ...
                    <div class="body">
                      <div class="input_file_wrap">
                        <span class="thumbnail_wrap m_r_10" v-if="profileURL">
                          <a v-on:click.prevent="deleteImage('profile')" class="del_icon">X</a><a class="edit_icon" v-on:click.prevent="editProfile('profile')">수정</a>
                  ...
                  <li>
                    ...
                    <div class="body">
                      <table>
                        ...
                        <tbody>
                        <tr v-for="product in represent_product">
                          <td>
                            <span class="thumbnail_wrap">
                              <img alt="기본 이미지" :src="product.main_image">
                            </span>
                          </td>
                          <td><span class="text">{{ product.name }}</span></td>
                          <td><span class="text">{{ product.discount_price ? product.discount_price : product.price | comma }}</span></td>
                        </tr>
                        </tbody>
                      </table>
                      <div class="but_wrap text-right">
                        <a class="m_t_10" v-on:click="isSetRepresentProduct = !isSetRepresentProduct">상품설정하기</a>
                      </div>
                    </div>
                    <div v-if="isSetRepresentProduct" style="margin-top: 15px; float:left; width:100%">
                      <RepresentativeProduct :isSuper="true" :storeId="store.id" :appliedRepresentProductArr="represent_product" :selectedRepresentProductCallback="selectedRepresentProductCallback" />
                    </div>
                  </li>
                </ul>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <div class="body"><input type="text" placeholder="내용을 입력해주세요." v-model.lazy="store.store_admin_email"></div>
                  </li>
                  <li>
                    <div class="title">담당자명<span class="color_r">&#42;</span></div>
                    <div class="body"><input type="text" placeholder="내용을 입력해주세요." v-model.lazy="store.store_admin_name"></div>
                  </li>
                  <li>
                    <div class="title">담당자연락처<span class="color_r">&#42;</span></div>
                    <div class="body"><input type="number" placeholder="- 를 제외한 번호만 입력해주세요." v-model.lazy="store.store_admin_phone"></div>
                  </li>
                </ul>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <div class="body">
                      <div class="address_wrap">
                        <input type="text" placeholder="우편번호" v-on:click="setAddress('return_exchange_address')" v-model="store.store_return_exchange_address.zipcode">
                        <a id="return_exchange_address" v-on:click="postCode">우편번호</a>
                        <input type="text" placeholder="주소" v-on:click="setAddress('return_exchange_address')" v-model="store.store_return_exchange_address.address">
                        <input type="text" placeholder="상세주소" v-model.lazy="store.store_return_exchange_address.detail_address">
                      </div>
                    </div>
                  </li>
                  <li>
                    ...
                    <div class="body">
                      <select v-model="store.store_return_exchange_address.delivery_company">
                        <option value="">택배사 선택</option>
                        <option v-for="deliveryCompany in deliveryCompanies" :key="deliveryCompany.value" :value="deliveryCompany.key">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <div class="body">
                      <input type="text" placeholder="은행명" v-model="store.store_return_exchange_account_info.bank_name">
                    </div>
                  </li>
                  <li>
                    <div class="title">예금주명</div>
                    <div class="body">
                      <input type="text" placeholder="예금주명" v-model="store.store_return_exchange_account_info.holder_name">
                    </div>
                  </li>
                  <li>
                    <div class="title">계좌번호</div>
                    <div class="body">
                      <input type="number" placeholder="계좌번호" v-model="store.store_return_exchange_account_info.account">
                    </div>
                  </li>
                </ul>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <div class="body"><input type="text" placeholder="내용을 입력해주세요." v-model.lazy="store.store_business_info.ceo_name"></div>
                  </li>
                  <li>
                    <div class="title">상호명<span class="color_r">&#42;</span></div>
                    <div class="body"><input type="text" placeholder="내용을 입력해주세요." v-model.lazy="store.store_business_info.company_name"></div>
                  </li>
                  <li>
                    <div class="title">사업자 등록번호<span class="color_r">&#42;</span></div>
                    <div class="body"><input type="number" placeholder="- 를 제외한 번호만 입력해주세요." v-model.lazy="store.store_business_info.license_num"></div>
                  </li>
                  <li>
                    <div class="title">통신판매 신고번호<span class="color_r">&#42;</span></div>
                    <div class="body"><input type="text" placeholder="- 를 제외한 번호만 입력해주세요." v-model.lazy="store.store_business_info.sale_num"></div>
                  </li>
                </ul>
                    ...
                    <div class="body">
                      <div class="input_file_wrap">
                        <span class="thumbnail_wrap m_r_10" v-if="licenseURL">
                          <a class="del_icon" v-on:click="deleteImage('license')">X</a><a class="edit_icon" v-on:click.prevent="editProfile('license')">수정</a>
                    ...
                    <div class="body">
                      <div class="input_file_wrap">
                        <span class="thumbnail_wrap m_r_10" v-if="saleURL">
                          <a class="del_icon" v-on:click="deleteImage('sale')">X</a><a class="edit_icon" v-on:click.prevent="editProfile('sale')">수정</a>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <div class="body">
                      <!-- 선택 가능 선택시에만 11번가 연동여부 체크박스 활성화  -->
                      <div class="radio_wrap">
                        <input type="radio" id="selectable" v-model="store.agency_selectable" :value="true">
                        <label for="selectable">선택 가능</label>
                        <input type="radio" id="not_selectable" v-model="store.agency_selectable" :value="false">
                        <label for="not_selectable">선택 불가</label>
                      </div>
                    </div>
                  </li>
                  <li v-if="store.agency_selectable">
                    <div class="title">11번가 연동 여부</div>
                    <div class="body">
                      <div class="checkbox_wrap pull-left">
                        <input type="checkbox" id="st11_linkable" v-model="store.st11_linkable">
                        <label for="st11_linkable">11번가 연동 가능</label>
                      </div>
                      <div class="text_input_wrap pull-left m_t_0">
                        <div>API KEY :</div>
                        <input type="text" placeholder="API KEY 입력" v-model="store.store_external_api_key.api_key" :disabled="!store.st11_linkable">
                      </div>
                    </div>
                  </li>
                </ul>
                  ...
                  <li>
                    ...
                    <div class="body">
                      <input
                        ...
                        v-model.lazy="store.store_balance_account_info.bank_name"
                      >
                    </div>
                  </li>
                  <li>
                    ...
                    <div class="body">
                      <input
                        type="text"
                        placeholder="내용을 입력해주세요."
                        v-model.lazy="store.store_balance_account_info.holder_name"
                      >
                    </div>
                  </li>
                  <li>
                    ...
                    <div class="body">
                      <input
                        ...
                        v-model.lazy="store.store_balance_account_info.account"
                      >
                    </div>
                  </li>
                  <li>
                    ...
                    <div class="body">
                      <input
                        ...
                        class="pull-left w_50"
                        v-model.lazy="store.store_balance_account_info.commission_rate"
                      >
                      <div class="pull-left m_l_10">%</div>
                    </div>
                  </li>
                </ul>

                <div class="but_wrap text-center">
                  <nuxt-link :to="`/super_admin/store/${store.id}`" class="line_but">취소</nuxt-link>
                  <a v-on:click="patchStore">수정</a>
                </div>
...
<script src="@/assets/javascripts/super_admin/store/edit/_id/index.js"></script>
