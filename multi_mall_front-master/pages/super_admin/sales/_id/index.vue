          ...
          <div class="col_wrap">
            ...
            <div class="col_three">
                  ...
                  <table class="show_table">
                    ...
                    <client-only>
                      <tr v-for="orderProduct in orderProduct.orderProducts">
                        <td>
                          <nuxt-link :to="`/super_admin/sales/${orderProduct.order_product_num}`" class="text">{{orderProduct.order_product_num}}</nuxt-link>
                        </td>
                        ...
                        <template v-if="orderProduct.rowspan !== 0">
                          ...
                          <td :rowspan="orderProduct.rowspan">{{orderProduct.store_name_kor}}</td>
                        </template>
                      </tr>
                    </client-only>
                    </tbody>
              ...
              <table class="show_table">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <div v-if="orderProduct.orderSubStatus === 'RQST_CNCL'" class="small_but_wrap pull-right">
                      <a href="javascript:;" class="line_but" @click="btnCancelAccept">취소완료처리</a>
                    </div>
                    <div v-else-if="['RQST_RTRN', 'PICKNG_PRDCT', 'CMPLT_PICK'].includes(orderProduct.orderSubStatus)" class="small_but_wrap pull-right">
                      <a href="javascript:;" class="line_but" @click="btnReturnComplete">반품완료처리</a>
                    </div>
                  </td>
                </tr>
                <tr>
                  <th>해외상품 URL</th>
                  <td>
                    <a v-if="orderProduct.productDetailUrl && orderProduct.productDetailUrl !== '-'" :href="orderProduct.productDetailUrl" target="_blank">{{orderProduct.productDetailUrl}}<br>[새창으로 열기]</a>
                  </td>
                  <th>멀티몰 상품 URL</th>
                  <td>
                    <client-only>
                ...
                <tr>
                  ...
                  <th>판매매장</th>
                  <td>{{orderProduct.orderProducts[0].store_name_kor}}</td>
                </tr>
                <tr>
                  <th>수량</th>
                ...
                <tr v-if="['CMPLT_CNCL', 'CMPLT_RFND'].includes(orderProduct.orderSubStatus)">
                  <th>총 상품 주문금액</th>
                  <td>
                  ...
                  <th>환불완료금액</th>
                  <td>{{ orderProduct.refundPrice | comma}}원
                    <div class="small_but_wrap pull-right">
                      <a href="javascript:;" class="line_but" @click="modifyRefundPrice(orderProduct)">취소금액수정</a>
                    </div>
                  </td>
                </tr>
                <tr v-else>
              ...
              <ul v-if="orderProduct.returnExchangeAddress">
                ...
                <li>
                  <div class="title">반품/교환비용 지불방법</div>
                  <div class="body">{{ (orderProduct.collect) ? orderProduct.collect.collect_fee_type_str : '' }}</div>
                </li>
                <li>
              ...
              <div class="but_wrap text-center">
                <nuxt-link :to="'/super_admin/sales/order'" class="line_but">목록</nuxt-link>
              </div>
            </div>
          </div>
        </div>
...
<script src="@/assets/javascripts/super_admin/sales/_id/index.js"></script>
