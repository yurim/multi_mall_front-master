                ...
                <li>
                  ...
                  >
                    <template v-slot:body="{item}">
                      <td>
                        <nuxt-link :to="`/super_admin/sales/${item.order_product_num}`" class="text">
                          {{item.order_num}}
                        </nuxt-link>
                      </td>
                      <td>
                      ...
                      <td>
                        <nuxt-link :to="`/super_admin/store/${item.store_id}`" class="text">
                          {{item.store_name_kor}}
                        </nuxt-link>
                      </td>
                      ...
                      <td>
                        <div v-if="item.order_sub_status === 'CMPLT_RFND'">
...
<script src="@/assets/javascripts/super_admin/sales/return_delivery/index.js"></script>
