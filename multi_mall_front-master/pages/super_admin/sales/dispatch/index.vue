          ...
          <div class="col_wrap">
            ...
            <div class="col_three">
                      ...
                      <div class="select_date_wrap">
                        <search-date-picker
                          ...
                          :dateTypes="[
                            ...
                            { text: '발송처리일', value: 'dispatch_processed_at' },
                          ]"
                          periodType="month"
                        ></search-date-picker>
                      </div>
              ...
              <ul class="table_wrap">
                ...
                <li>
                  <span class="table_size_l sales_dispatch_wrap">
                  <data-table
                    ref="dataTable"
                    :loading="loading"
                    :headers="headers"
...
<script src="@/assets/javascripts/super_admin/sales/dispatch/index.js"></script>
