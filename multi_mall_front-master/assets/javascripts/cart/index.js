...
export default {
  ...
  methods: {
    ...
    isValidProduct(cart) {
      return (cart.product_info && cart.product_info.is_sale && cart.product_info.is_listed && !cart.product_info.is_blocked) && !this.isOutOfStock(cart);
    },
    isOutOfStock(cart) {
      if (cart.option_info) return cart.option_info.is_inventory_managed && cart.option_info.inventory_amount <= 0;
      return true;
    },
