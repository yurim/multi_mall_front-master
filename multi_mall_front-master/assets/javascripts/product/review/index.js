...
export default {
  ...
  methods: {
    progressLinearValueScoreStats(scoreStats, scoreNum, totalReviewCount = 0) {
      if (scoreStats && scoreNum && totalReviewCount > 0 && scoreStats[scoreNum]) {
        return (scoreStats[scoreNum] / totalReviewCount) * 100;
      }
      return 0;
    },
    reviewScoreStr(scoreStats, scoreNum) {
      if (scoreStats && scoreStats[scoreNum]) {
        return scoreStats[scoreNum];
      }
      return 0;
    },
    // 국내 리뷰 func
