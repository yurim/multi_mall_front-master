...
export default {
  ...
  async fetch({ store, params, redirect }) {
    ...
    // product_price_group
    const groupRes = await store.dispatch(`${prefix}/getProductPriceGroup`, { groupId });
    ...
    await store.dispatch(`${prefixOtherStore}/getOtherProductReviews`, { groupId, query: { page_size: 2 } });
  },
  computed: {
    ...mapGetters({
