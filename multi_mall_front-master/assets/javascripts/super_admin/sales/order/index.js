...
const prefix = 'super_admin/sales/order';
        ...
        propsData: {
          okCallback: async (params) => {
            ...
            const res = await this.$axios.$put(`${prefix}/order_delivery`, {
              order_ids: [this.selectedItem.order_id],
              name: params.name,
              phone: params.phone,
          ...
          new this.$popup.Confirm({
            propsData: {
              ...
              okCallback: async (inParams) => {
                const res = await that.$axios.$post('super_admin/sales/dispatch/selected_check_delivery', params);
